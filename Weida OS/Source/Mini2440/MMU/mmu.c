...
void MMU_Init(void)
{
    ...
    MMU_SetMTT(0x00000000, 0x03f00000, (int)__Start, RW_CB); //bank0
    ...
    MMU_SetMTT(0x30000000, 0x33700000  /*0x30100000*/, 0x30000000, RW_CB);	 //bank6-1
    MMU_SetMTT(/*0x30200000 */ 0x33800000, 0x33e00000, 0x33800000, RW_NCNB); //bank6-2
    //
